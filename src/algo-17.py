...
@algo_player(name="Liuri Loami 16 - Ultimate 10",
...
def liuriloami(board, game_id, player_id):
    ...
    for tile_id, tile in board.items():
        ...
        if (tile["player"] is None and neighbours < bestCorner and vul >= crit and isTileSafe(tile_id, player_id, board) is False):
            corner = True
